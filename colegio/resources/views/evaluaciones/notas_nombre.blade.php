...
@section('content')
  ...
  <div class="box">
    <div class="box-body">
      ...
      <form method="POST" action="{{route('notas.store')}}" accept-charset="UTF-8" id="tocult">
      {{ csrf_field() }}
      ...
      <div class="row" id="varios" style="display: none">
        <div class="col col-xs-12">
          ...
          <button class="btn btn-danger " type="button" onclick="pdf();" id="btnPDF" data-toggle="tooltip" title="Reporte de evaluacion por lapso"><i class="fa fa-print"></i> Reporte</button>
          <button class="btn btn-danger " type="button" onclick="pdf2();" id="btnPDF" title="Reporte Actuación general del Estudiante"><i class="fa fa-print"></i> Rep Act</button>
          <button class="btn btn-danger " type="button" onclick="pdf3();" id="btnPDF" title="Reporte final de año"><i class="fa fa-print"></i> Rep Def</button>
  ...
  function llenar(bandera) {
    ...
    if (document.getElementById('mater').value != "" && document.getElementById('lap').value != "") {
      ...
      $.get("notas/tabla/"+id,function (reponse,state) {
        ...
        console.log(lapso+" "+seccion+" "+materia+" "+escolar+" "+final);
        ...
        for (var i = 0; i < reponse.notas.length; i++) {
          ...
          var npond   = document.getElementById('npond'+i).value;
          ...
          if (final == 1) {
            rows.push({
              ...
              "n5": n5,
              "n5_112": n5_112,
              "npond": parseFloat(npond).toFixed(2),
              "rasg": rasg,
              "aj": parseFloat(aj).toFixed(2),
              "naj": parseFloat(naj).toFixed(2),
              "n70": parseFloat(n70).toFixed(2),
              "fl": parseFloat(fl).toFixed(2),
              "fl_112": parseFloat(fl_112).toFixed(2),
              "n30": parseFloat(n30).toFixed(2),
